                    ...
                    <div className="w-75">
                        <div>
                            ...
                            <div className="input-group">
                                ...
                                <input id="account" className="form-control bg-white" placeholder="account_name" />
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="input-group">
                                ...
                                <input id="mail" placeholder="@gmail.com" className="form-control bg-white" />
                            </div>
                        </div>
                        <div>
                            <label>生年月日</label>
                        ...
                        <div>
                            ...
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="flexRadioDefault" id="no_answer" />
